	...
	// Gras image
	var grasReady = false;
	var grasImage = new Image();
	grasImage.onload = function () {
		'use strict';
		grasReady = true;
	};
	grasImage.src = 'images/gras.png';
	...
	(function(){
		...
		Player.prototype.draw = function(context, xView, yView){	
			...
			context.drawImage(heroImage, (this.x-this.width/2) - xView, (this.y-this.height/2) - yView, this.width, this.height);
			context.restore();			
		};
	...
	(function(){
		...
		// generate an custom map
		Map.prototype.generateCustomMap = function(){
			//this.width = 600;
			//this.height = 600;
			var tiles = [[]];
			for (var i = 0; i < 10; i++) {
